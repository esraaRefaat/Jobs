        ...
        <Card sx={{ width: '274px', height: '190px'}}>
            <SvgIcon sx={{ paddingLeft: '32px', paddingTop: '32px' }}>
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_1509_1280)">
            ...
            <CardContent sx={{ paddingTop: '32px', paddingLeft: '32px' }}>
                ...
                <SvgIcon  sx={{marginBottom:'6px'}}>
                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M19.75 12.2261L4.75 12.2261" stroke="#25324B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M13.7002 6.20149L19.7502 12.2255L13.7002 18.2505" stroke="#25324B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
